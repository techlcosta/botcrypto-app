...
export function SymbolsTableRow ({ row, callback }: RowProps) {
  return (
    <tr className='bg-slate-800 hover:opacity-70'>
      <td className='py-3 px-2 text-center rounded-tl-md rounded-bl-md'>
      ...
      <td className='py-3 px-2 text-center'>{row.basePrecision}</td>
      <td className='py-3 px-2 text-center'>{row.quotePrecision}</td>
      <td className='py-3 px-2 text-center'>{row.minNotional}</td>
      <td className='py-3 px-2 text-center'>{row.minLotSize}</td>
      <td className='py-3 px-2 text-center rounded-tr-md rounded-br-md'>
